# name          : tanzania_unilateral.R
# description   : Exploration of Tanzania Data
# maintainer    : Arnob L. Alam <aa2288a@student.american.edu>
# updated       : 2016-05-11
#
# Initial exploration of Tanzania Risk Sharing Netwrok Data, assuming you
# can have unilateral links
...
tanzania_graph <- graph_from_edgelist(as.matrix(links), directed = TRUE)
